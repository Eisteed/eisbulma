...
/**
 * WooCommerce Hook: AJAX Filters
 *
 * Provides AJAX-powered product filtering with Bulma UI components.
 * Includes category, price range, stock status, sale status, and rating filters.
 *
 * @package EisBulma
 * @since 1.0.0
 */
...
add_action('woocommerce_before_shop_loop', function () {
    ...
    echo '
            ...
            <div class="columns">
                <aside id="woo-filters" class="column p-3 is-3-desktop is-full-mobile">
...
function woo_bulma_filters_markup()
{
    ...
    ob_start();
?>
    <div class="woo-filter-box has-background-grey-lighter p-3">
        ...
        <h3 class="title is-5 mb-4 tag"><?php echo esc_html__('Filter products', 'eisbulma'); ?></h3>
