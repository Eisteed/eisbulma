<?php
/**
 * WooCommerce Template: Tabs Accordion
 *
 * Renders product tabs as an accordion using HTML details/summary elements.
 * Description tab is first and open by default.
 *
 * @package EisBulma
 * @since 1.0.0
 */
...
foreach ( $tabs as $key => $tab ) {
    ...
    echo '<details class="accordion-item mb-4"'.$open.'>';
        echo '<summary class="button is-primary is-fullwidth is-justify-content-space-between" style="width:95%">';
