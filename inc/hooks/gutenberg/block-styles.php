...
add_editor_style('src/styles/gutenberg-editor/gutenberg-editor-bulma.css');
...
{
    $json_path = get_stylesheet_directory() . '/src/styles/gutenberg-editor/bulma-blocks.json';
