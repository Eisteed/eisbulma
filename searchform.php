...
<form role="search" method="get" id="searchform" class="search-form mr-auto ml-auto" action="<?php echo esc_url(home_url('/')); ?>" >
	...
	<div class="field has-addons" >
		<div class="control has-icons-right has-icons-left">
			<input type="text" class="input is-small" value="<?php the_search_query(); ?>" name="s" id="<?php echo esc_attr('s' . $form_id); ?>" placeholder="<?php echo esc_attr_x('Search &hellip;', 'placeholder', 'eisbulma'); ?>" />
